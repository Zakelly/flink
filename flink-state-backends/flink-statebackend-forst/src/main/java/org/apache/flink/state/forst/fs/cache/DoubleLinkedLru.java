 ...
 * This cache maintains two linked lists to manage the cache entries.
 * The first list contains the most recently used entries, and the second list contains the less recently used entries.
 * The cache also maintains a middle pointer to efficiently manage the entries.
 * No thread-safe guarantees are provided.
 *
 * @param <K> the type of keys maintained by this cache
 * @param <V> the type of mapped values
 */
public abstract class DoubleLinkedLru<K, V> {
    ...
    /**
     * Checks if it is safe to add a value to the first list. Will be called before adding a value to the first list.
     *
     ...
     * Optionally affects the order of the entries in the cache.
     *
     * @param key the key of the entry
